...
module.exports = {
    ...
    output: {
        // How and where webpack should output your bundles, assets, etc. See: https://webpack.js.org/configuration/output/
        filename: "bundle.js",
        path: path.resolve(__dirname, "dist"),
    },
    devtool: "source-map", // Enable sourcemaps for debugging webpack's output.
    devServer: {
        // Behavior configuration of webpack-dev-server. See: https://webpack.js.org/configuration/dev-server/
        port: 8080,
    },
    resolve: {
        // Module resolution settings. See: https://webpack.js.org/configuration/resolve/
        alias: {
    ...
    module: {
        // Module handling settings. See: https://webpack.js.org/configuration/module/
        rules: [
            {
